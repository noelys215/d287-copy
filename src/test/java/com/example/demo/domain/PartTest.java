...
class PartTest {
    ...
    void getSetMinInventory() {
        partIn.setMinInv(10);
        assertEquals(10, partIn.getMinInv(), "Min inventory set and retrieved correctly for InhousePart.");

        partOut.setMinInv(5);
        assertEquals(5, partOut.getMinInv(), "Min inventory set and retrieved correctly for OutsourcedPart.");
    }

    @Test
    void getSetMaxInventory() {
        partIn.setMaxInv(100);
        assertEquals(100, partIn.getMaxInv(), "Max inventory set and retrieved correctly for InhousePart.");

        partOut.setMaxInv(50);
        assertEquals(50, partOut.getMaxInv(), "Max inventory set and retrieved correctly for OutsourcedPart.");
    }
    ...
    void testInventoryValidation() {
        ...
        partIn.setMaxInv(50);
        partIn.setInv(30);
        assertTrue(partIn.isInventoryValid(), "Inventory within range should return true.");

        partIn.setInv(9);
        assertFalse(partIn.isInventoryValid(), "Inventory below minimum should return false.");

        partIn.setInv(51);
        assertFalse(partIn.isInventoryValid(), "Inventory above maximum should return false.");
    }
